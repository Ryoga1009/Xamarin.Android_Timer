...
namespace XamarinAndroid
{
	...
	public class MainActivity : Activity
	{
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			...
			TimeSUMText = FindViewById<TextView>(Resource.Id.TimeSUMText);
			...
			sp = new SoundPool(8, Android.Media.Stream.Music, 0);
			//loadSound(Resource.Raw.sample);
		...
		private void loadSound(int rawId)
		{
			// コンテキスト
			// リソースID
			// 優先度（今は効果がないけど将来への互換性のために 1 を指定してね、だって）
			//int soundId = sp.Load(this, rawId, 1);
			//rawIdToSoundId.Add(rawId, soundId);
		}
